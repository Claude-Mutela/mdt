        ...
        <table className="w-full text-left border-collapse text-sm border-2 border-slate-300">
          <thead>
            <tr className="bg-slate-100 print:bg-slate-100">
              <th className="border border-slate-300 px-4 py-3 font-bold text-slate-700">
                Nom complet
              </th>
              <th className="border border-slate-300 px-4 py-3 font-bold text-slate-700">
                Contact
            ...
            {members.length > 0 ? (
              members.map((m) => (
                <tr key={m.id} className="hover:bg-slate-50 print:break-inside-avoid">
                  ...
                  <td className="border border-slate-300 px-4 py-2">
                    <span
                      className={`font-semibold text-xs uppercase ${m.statut === 'actif' ? 'text-green-600' : 'text-red-600'}`}
                    >
                      {m.statut}
                    </span>
                  </td>
