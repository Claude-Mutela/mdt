  ...
  return (
    ...
    >
      <div className="relative aspect-video overflow-hidden bg-slate-100">
        ...
        />
        <div
          className={`absolute top-4 left-4 ${getBadgeColor()} text-white text-[10px] font-black px-3 py-1.5 rounded-lg uppercase tracking-widest shadow-lg`}
        >
          {item.type}
        </div>
        {item.duration && (
      ...
      <div className="p-8 flex flex-col flex-grow">
        ...
        <h3 className="text-xl font-bold font-serif text-slate-900 mb-6 leading-tight group-hover:text-primary transition-colors">
          {item.title}
        </h3>
        {item.speaker && <p className="text-slate-500 text-sm font-medium mb-4">{item.speaker}</p>}
  ...
  return (
    <>
      <Head title="Médiathèque — Phila MDT">
        <meta
          name="description"
          content="Explorez l'ensemble de nos ressources spirituelles classées par catégorie : vidéos, audios, photos, et documents d'édification."
        />
      </Head>
            ...
            >
              ...
              {selectedItem.type === 'audio' && (
                <div className="p-8 md:p-12 bg-gradient-to-br from-slate-900 to-slate-800 flex flex-col items-center gap-6 text-center">
                  ...
                  <audio controls autoPlay className="w-full max-w-md mt-4">
                    <source src={selectedItem.url} />
