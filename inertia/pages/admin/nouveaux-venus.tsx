                ...
                {newcomers.data.length === 0 ? (
                  ...
                  newcomers.data.map((nv) => (
                    <tr key={nv.id} className="hover:bg-slate-800/10 transition-colors group">
                      ...
                      <td
                        className="px-6 py-4 text-slate-400 font-medium max-w-[150px] truncate"
                        title={getHeardAboutLabel(nv.heardAbout)}
                      >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-wrap gap-1">
                          ...
                          {nv.joinCell && (
                            <span className="px-1.5 py-0.5 text-[9px] font-bold rounded bg-purple-500/10 text-purple-400 border border-purple-500/20">
                              Cellule
                            </span>
                          )}
                          {nv.serve && (
                            <span className="px-1.5 py-0.5 text-[9px] font-bold rounded bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
                              Servir
                            </span>
                          )}
                          {nv.comeBack && (
                            <span className="px-1.5 py-0.5 text-[9px] font-bold rounded bg-pink-500/10 text-pink-400 border border-pink-500/20">
                              Revient
                            </span>
                          )}
                          {!nv.baptized &&
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-bold text-sm">
                      {modal === 'add'
                        ? 'Ajouter un nouveau venu'
                        : 'Modifier la fiche de nouveau venu'}
                    </h3>
                    <p className="text-slate-400 text-[10px]">
                      Renseignez les informations de la personne
                    </p>
                  </div>
                </div>
                <button
              ...
              <form onSubmit={submit} className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      />
                      {form.errors.date && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.date}</p>
                      )}
                    </div>
                    <div>
                      <label className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">
                      ...
                      {form.errors.lastname && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.lastname}</p>
                      )}
                    </div>
                    <div>
                      <label className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">
                      ...
                      {form.errors.firstname && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.firstname}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      {form.errors.gender && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.gender}</p>
                      )}
                    </div>
                    <div>
                      <label className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">
                      ...
                      {form.errors.profession && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.profession}</p>
                      )}
                    </div>
                    <div>
                      <label className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">
                      ...
                      {form.errors.maritalStatus && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.maritalStatus}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      />
                      {form.errors.phone && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.phone}</p>
                      )}
                    </div>
                    <div>
                      <label className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold">
                      ...
                      />
                      {form.errors.email && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.email}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="md:col-span-1">
                      ...
                      />
                      {form.errors.city && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.city}</p>
                      )}
                    </div>
                    <div className="md:col-span-2">
                      ...
                      />
                      {form.errors.address && (
                        <p className="text-red-400 text-[10px] mt-1">{form.errors.address}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {form.errors.heardAbout && (
                      <p className="text-red-400 text-[10px] mt-1">{form.errors.heardAbout}</p>
                    )}
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {form.errors.suggestions && (
                      <p className="text-red-400 text-[10px] mt-1">{form.errors.suggestions}</p>
                    )}
                  </div>
                </div>
              </form>
              ...
              <div className="p-6 text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs mt-1">
                    Voulez-vous vraiment retirer la fiche de{' '}
                    <strong>
                      {selectedNewcomer.firstname} {selectedNewcomer.lastname}
                    </strong>{' '}
                ...
                {printPeriodType === 'month-year' && (
                  <div>
                    ...
                    <select
                      value={printMonth}
                      onChange={(e) =>
                        setPrintMonth(e.target.value === '' ? '' : Number(e.target.value))
                      }
                      className="w-full px-3 py-2.5 bg-slate-800 border border-slate-700 rounded-xl text-xs text-white font-semibold focus:outline-none focus:border-primary cursor-pointer font-bold"
                    >
