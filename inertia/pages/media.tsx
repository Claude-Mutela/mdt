  ...
  return (
    <>
      <Head title="Médias — Phila MDT">
        <meta
          name="description"
          content="Découvrez nos enseignements en vidéo, podcasts audio et reportages photo pour nourrir votre vie spirituelle."
        />
      </Head>
  ...
  return (
    <article onClick={onPlay} className="group cursor-pointer space-y-4">
      ...
      <div className="space-y-2">
        ...
        <h3 className="text-slate-900 text-xl font-bold font-serif leading-tight group-hover:text-primary transition-colors">
          {title}
        </h3>
