...
const Donation: React.FC = () => {
  ...
  const westernUnion = {
    ...
    beneficiary: 'Prisca MASSAMBA MALUENGO',
  }
  const equity = {
    id: 'eq1',
    name: 'EQUITY BCDC',
    accountName: 'PHILA MDT',
    accountNumberUSD: '500200204667272',
    accountNumberCDF: '500200204987954',
    accountNumberEUR: '500200204992804',
    swift: 'BCDCCDKI',
  }
  const vodacom = {
    id: 'mm1',
    operateur1: 'M-Pesa',
    phoneNumber: '243832000083',
    beneficiary: 'Prisca MASSAMBA',
  }
  const orange = {
    id: 'mm2',
    operateur1: 'Orange Money',
    phoneNumber: '243892100089',
    beneficiary: 'Prisca MASSAMBA',
  }
  const airtel = {
    id: 'mm3',
    operateur1: 'Airtel Money',
    phoneNumber: '243982000089',
    beneficiary: 'Prisca MASSAMBA',
  }
  ...
  return (
    <>
      <Head title="Donation - Phila Maison de Témoignages">
        <meta
          name="description"
          content="Soutenez l'œuvre de Dieu et les actions sociales de la Phila Maison de Témoignages en faisant un don en ligne sécurisé."
        />
      </Head>
      <div className="bg-background-off min-h-screen animate-in fade-in slide-in-from-bottom-6 duration-700 pb-24">
        ...
        <section className="bg-primary text-white pt-24 pb-20 text-center px-4 relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto space-y-6 relative z-10">
            ...
            <p className="text-white/80 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
              À PHILA MDT, chaque offrande est une semence d'impact. Grâce à vous, des âmes
              entendent l'Évangile, des vies sont restaurées, et l'Église grandit.
            </p>
          </div>
        </section>
        ...
        <div className="max-w-6xl mx-auto px-4 mt-16 space-y-24">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <a
              href="#en-ligne"
              className="group bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all text-center space-y-4 flex flex-col items-center"
            >
              ...
              <p className="text-slate-500 text-sm">
                Donnez facilement depuis votre téléphone ou ordinateur, en toute sécurité.
              </p>
            ...
            >
              ...
              <p className="text-slate-500 text-sm">
                Transférez votre don vers nos comptes officiels et recevez un reçu.
              </p>
            ...
            >
              ...
              <p className="text-slate-500 text-sm">
                Offrez des vivres, du matériel ou tout autre bien utile à la mission.
              </p>
          ...
          <section id="en-ligne" className="scroll-mt-24">
            <div className="text-center space-y-4 mb-12">
              <h2 className="text-3xl md:text-4xl font-black font-serif text-slate-900">
                Paiement en Ligne
              </h2>
              <p className="text-slate-500 max-w-2xl mx-auto">
                Sélectionnez le montant et votre méthode de paiement préférée. La transaction est
            ...
            <div className="max-w-3xl mx-auto bg-white rounded-[40px] shadow-2xl p-8 md:p-12 border border-slate-100">
              <p className="text-primary font-bold text-center max-w-2xl mx-auto">
                Paiement en ligne pas encore disponible. Veuillez utiliser nos coordonnées
                bancaires. ou mobile money ci-dessous
              </p>
          ...
          <section id="bancaire" className="scroll-mt-24 pt-12">
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-slate-500 max-w-2xl mx-auto">
                Effectuez un virement bancaire ou un transfert international en utilisant les
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-[32px] border border-slate-100 shadow-xl relative overflow-hidden group">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">
                      Numéro de Compte (USD)
                    </p>
                    <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                      <span className="font-black text-slate-900 font-mono tracking-wider break-all">
                        {equity.accountNumberUSD}
                      </span>
                      <button
                        onClick={() => handleCopy(equity.accountNumberUSD, equity.id)}
                  ...
                  <div className="space-y-2">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">
                      Numéro de Compte (CDF)
                    </p>
                    <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                      <span className="font-black text-slate-900 font-mono tracking-wider break-all">
                        {equity.accountNumberCDF}
                      </span>
                      <button
                        onClick={() => handleCopy(equity.accountNumberCDF, equity.id)}
                        className={`p-2 rounded-lg transition-all ${copied === equity.id ? 'bg-emerald-500 text-white' : 'bg-white text-primary hover:bg-primary hover:text-white shadow-sm'}`}
                      >
                        {copied === equity.id ? <Check size={16} /> : <Copy size={16} />}
                      </button>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                      <span className="font-black text-slate-900 font-mono tracking-wider break-all">
                        {equity.accountNumberEUR}
                      </span>
                      <button
                        onClick={() => handleCopy(equity.accountNumberEUR, equity.id)}
                        className={`p-2 rounded-lg transition-all ${copied === equity.id ? 'bg-emerald-500 text-white' : 'bg-white text-primary hover:bg-primary hover:text-white shadow-sm'}`}
                      >
                        {copied === equity.id ? <Check size={16} /> : <Copy size={16} />}
                      </button>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                      ...
                      <button
                        onClick={() => handleCopy(equity.swift, equity.id)}
                        className={`p-2 rounded-lg transition-all ${copied === equity.id ? 'bg-emerald-500 text-white' : 'bg-white text-primary hover:bg-primary hover:text-white shadow-sm'}`}
                      >
                        {copied === equity.id ? <Check size={16} /> : <Copy size={16} />}
                      </button>
              ...
              <div className="bg-white p-8 md:p-10 rounded-[32px] border border-slate-100 shadow-xl relative overflow-hidden group">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">
                      {vodacom.operateur1} | Bénéficiaire: {vodacom.beneficiary}
                    </p>
                    <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                      <span className="font-bold text-slate-700">{vodacom.phoneNumber}</span>
                      <button
                        onClick={() => handleCopy(vodacom.phoneNumber, vodacom.id)}
                        className={`p-2 rounded-lg transition-all ${copied === vodacom.id ? 'bg-emerald-500 text-white' : 'bg-white text-primary hover:bg-primary hover:text-white shadow-sm'}`}
                      >
                  ...
                  <div className="space-y-2">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">
                      {vodacom.operateur1} | Bénéficiaire: {orange.beneficiary}{' '}
                    </p>
                    <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                      <span className="font-bold text-slate-700">{orange.phoneNumber}</span>
                      <button
                        onClick={() => handleCopy(orange.phoneNumber, orange.id)}
                        className={`p-2 rounded-lg transition-all ${copied === orange.id ? 'bg-emerald-500 text-white' : 'bg-white text-primary hover:bg-primary hover:text-white shadow-sm'}`}
                      >
                  ...
                  <div className="space-y-2">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">
                      {airtel.operateur1} | Bénéficiaire: {airtel.beneficiary}{' '}
                    </p>
                    <div className="flex items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 border border-slate-100">
                      <span className="font-bold text-slate-700">{airtel.phoneNumber}</span>
                      <button
                        onClick={() => handleCopy(airtel.phoneNumber, airtel.id)}
                        className={`p-2 rounded-lg transition-all ${copied === airtel.id ? 'bg-emerald-500 text-white' : 'bg-white text-primary hover:bg-primary hover:text-white shadow-sm'}`}
                      >
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
                <div className="space-y-6">
                  ...
                  <h2 className="text-3xl md:text-5xl font-black font-serif leading-tight">
                    Votre donation en nature
                  </h2>
                  <p className="text-white/80 text-lg leading-relaxed">
                    Vos offrandes en nature, qu'il s'agisse de vivres, de produits agricoles,
                    d'équipements, d'instruments ou de matériel de service, participent directement
                    à l'œuvre de Dieu.
                  </p>
                  <p className="text-white/80 text-lg leading-relaxed">
                    Chaque offrande est reçue avec reconnaissance, utilisée avec sagesse et gérée
                    avec transparence.
                  </p>
                  <div className="pt-4">
                    <a
          ...
          <section className="pt-12 max-w-3xl mx-auto">
            <div className="text-center space-y-4 mb-12">
              ...
              <p className="text-slate-500">
                Tout ce que vous devez savoir sur le processus de donation.
              </p>
            </div>
              ...
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`flex-shrink-0 text-slate-400 transition-transform duration-300 ${activeFaq === index ? 'rotate-180 text-primary' : ''}`}
                    />
                  </button>
                  <div
          ...
          <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 text-center max-w-2xl mx-auto">
            ...
            <span className="block mt-4 text-xs font-bold uppercase tracking-widest text-primary">
              — 2 Corinthiens 9:7
            </span>
          </div>
        </div>
