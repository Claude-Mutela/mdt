        ...
        <meta
          ...
          content={
            activity.desc
              ...
              : `Découvrez le ministère "${activity.name}" de la Phila Maison de Témoignages.`
          }
        />
      </Head>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
            <div className="max-w-4xl mx-auto space-y-4">
              ...
              <div className="space-y-2">
                <span
                  className={`${activity.color} text-white text-[10px] md:text-xs font-black px-3 py-1 rounded-lg uppercase tracking-widest inline-block`}
                >
                  {activity.tag}
                </span>
          ...
          <div className="max-w-4xl mx-auto grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-slate-500 italic">{activity.desc}</p>
              </div>
