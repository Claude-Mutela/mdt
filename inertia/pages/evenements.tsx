...
export default function Evenements({ events }: Props) {
  ...
  const filteredEvents =
    selectedCategory === 'all' ? events : events.filter((e) => e.tag === selectedCategory)
  ...
  return (
    <>
      <Head title="Événements - Phila Maison de Témoignages">
        <meta
          name="description"
          content="Découvrez tous les événements, conférences, séminaires et célébrations organisés par la Phila Maison de Témoignages."
        />
      </Head>
